...
namespace Dune {
  ...
  private:
    static unsigned maxOrder (const GeometryType& t, QuadratureType qt)
    {
      if (t.isLine())
      {
        ...
        case QuadratureType::GaussRadauLeft :
          return GaussRadauLeftQuadratureRule<ctype>::highest_order;
        case QuadratureType::GaussRadauRight :
          return GaussRadauRightQuadratureRule<ctype>::highest_order;
        default :
    ...
    static QuadratureRule<ctype, dim> rule (const GeometryType& t, int p, QuadratureType qt)
    {
      if (t.isLine())
      {
        ...
        case QuadratureType::GaussRadauLeft :
          return GaussRadauLeftQuadratureRule<ctype>(p);
        case QuadratureType::GaussRadauRight :
          return GaussRadauRightQuadratureRule<ctype>(p);
        default :
          DUNE_THROW(Exception, "Unknown QuadratureType");
        }
      }
  ...
  extern template class GaussRadauLeftQuadratureRule<double>;
  extern template class GaussRadauRightQuadratureRule<double>;
